...
def main(args):
    ...
    if args.train_datadir is not None:
        cfg.data['train_gulp_dir'] = args.train_datadir
    if args.val_datadir is not None:
        cfg.data['val_gulp_dir'] = args.val_datadir
    ...
    checkpoint_callback = ModelCheckpoint(save_top_k= 1,save_last=True, monitor='train_loss', period= 10)
